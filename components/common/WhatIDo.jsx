                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="experience-content wow fadeInUp">
                      <h3 className="ex-title fw-bold">Cloud Security Readiness</h3>
                      <p className="ex-para">
                  ...
                  <div className="col-lg-6">
                    <div className="experience-content wow fadeInUp">
                      <h3 className="ex-title fw-bold">Audit & Compliance Leadership</h3>
                      <p className="ex-para">
                  ...
                  <div className="col-lg-6">
                    <div className="experience-content wow fadeInUp">
                      <h3 className="ex-title fw-bold">Governance, Risk, & Control (GRC)</h3>
                      <p className="ex-para">
                  ...
                  <div className="col-lg-6">
                    <div className="experience-content wow fadeInUp">
                      <h3 className="ex-title fw-bold">Security Assessments & Remediation</h3>
                      <p className="ex-para">
